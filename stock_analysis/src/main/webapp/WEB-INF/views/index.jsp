...
<body>
	...
	<form action="login" method="post">
		<label for="id"> ID : <input type="text" name="id" id="id" required="required"></label><br />
		<label for="pass"> PASS : <input type="text" name="pass" id="pw" required="required"></label>
...
<center>
<a    href="javascript:fn_articleForm('../boardWrite)"><p class="btn btn-info">글쓰기</p></a>
</center>
</body>
</html>